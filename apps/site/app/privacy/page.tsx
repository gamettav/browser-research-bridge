...
export default function Privacy() {
  return (
    <main className="legal wrap">
      ...
      <p>Browser Research&apos;s use of information received from Chrome complies with the Chrome Web Store User Data Policy, including the Limited Use requirements.</p>
      ...
      <p>Requested websites and search providers receive ordinary network requests from Chrome and apply their own privacy policies. Browser Research does not sell data, use it for advertising or creditworthiness, transfer it to a Browser Research cloud service, or enable remote telemetry by default.</p>
