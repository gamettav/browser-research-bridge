...
export default function Security() {
  return (
    <main className="legal wrap">
      ...
      <h2>Boundary</h2>
      <p>The Chrome extension and agent plugin communicate only over loopback. First-run pairing uses short-lived bidirectional proofs; later connections use mutual nonce-based authentication. The long-lived credential is never shown to the user or transmitted after pairing.</p>
      ...
      <p>Install the extension only in a Chrome profile whose readable sites you are comfortable granting to the agent. Chrome site-access restrictions can provide an allowlist. A separate low-privilege profile remains the strongest option for people who routinely keep sensitive services signed in.</p>
